                ...
                <nav className={`space-y-1 flex-1 overflow-y-auto ${isCollapsed ? 'lg:px-2' : 'px-3'}`}>
                    {menuItems.map((item) => (
                        ...
                        >
                            ...
                            <div className={`hidden absolute left-full ml-2 px-3 py-2 bg-gray-900 text-white text-sm rounded-lg pointer-events-none transition-opacity whitespace-nowrap z-50 ${
                                isCollapsed ? 'lg:group-hover:block lg:group-hover:opacity-100' : ''
                            }`}>
                                {item.name}
